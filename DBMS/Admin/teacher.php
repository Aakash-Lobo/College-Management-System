...
<?php  
 	if (isset($_POST['btn_save'])) {
		...
		$permanent_address=$_POST["permanent_address"];
 		...
 		$query="Insert into teacher_info(first_name,middle_name,last_name,email,phone_no,teacher_status,application_status,dob,gender,permanent_address,current_address,place_of_birth,hire_date)values('$first_name','$middle_name','$last_name','$email','$phone_no','$teacher_status','$application_status','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$date')";
...
<body>
    ...
    <main class="col-xl-10 ml-sm-auto pl-4 pr-2 w-100 cp-2">
        <div class="sub-main">
            <div class=" flex-md-no-wrap pt-3 pb-2 mb-3 p-3 text-white admin-dashboard pl-3">
                <div class="d-flex">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="browser-default custom-select"
                                                        ...
                                                        <option value="Permanent">Approved</option>
                                                        <option value="Contract">Not Approved</option>
                                                    </select>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Enter Total
                                                                    Classes:*</label>
                                                                <input type="text" name="total_classes"
                                                                    class="form-control" required>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <table class="w-100 table-elements mb-5 table-three-tr" cellpadding="10">
                            ...
                            <?php 
								...
								while($row=mysqli_fetch_array($run)) {
									...
									echo	"<td width='170'> <a class='btn btn-danger' href=delete-function.php?teacher_id=".$row['teacher_id'].">Delete</a></td>";
									echo "</tr>";
								}
								?>
                        </table>
