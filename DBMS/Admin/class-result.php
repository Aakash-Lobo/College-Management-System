...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			...
			if ($run) {
				$success_message = "Results Has Been Submitted Successfully";
			}	
			else{
				$error_message = "Results Has Not Been Submitted Successfully";
			}
		}
	}
            ...
            <div class="col-md-12">
                ...
                <form action="class-result.php" method="post">
                    <div class="row	">
                        ...
                        <div class="col-md-6">
                            <input type="submit" name="submit" class="btn btn-primary px-5" value="Display">

                            <a class="btn btn-outline-primary ml-auto mr-2" href="add-single-student-results.php">Single
                                Student Result</a>
                    ...
                    <table class="w-100 table-elements table-three-tr" cellpadding="3">
                        ...
                        <form action="class-result.php" method="post">
                            <tr>
                                ...
                                <td><input type="text" name="obtain_marks[]" placeholder="Enter Marks Obtained"
                            ...
                            <input type="submit" name="sub" class="btn btn-success px-4 ml-2 mb-2" value="Update">
                        </form>
                    </table>
                </section>
            </div>
